...
from google.colab.patches import cv2_imshow # i wrote this code in colab if you don't you can delete this

img = cv2.imread("truckAndCar.jpg")
cv2_imshow(img)
print(img.shape)
...
img_blob = cv2.dnn.blobFromImage(img, 1/255, (416, 416), swapRB = True)  #foto 4 boyutlu tanımlandı
